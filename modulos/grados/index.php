        ...
        <div class="contenedor-principal">
            <div class="header">
                ...
                <div class="boton-nuevo" id="btn-new" onClick="newAlert()">
                    <a href="#"><i class="fas fa-level-up-alt fa-lg" title="Añadir nuevo grado"></i></a>
                </div>
            ...
            <table id="table_grados" class="table table-striped table-bordered" style="width:100%; height:80%">
