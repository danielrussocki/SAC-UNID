      ...
      <div class="contenedor-principal">
        ...
        <table id="table_id" class="table table-striped table-bordered" style="width:100%; height:80%">
            ...
            <tbody>
              ...
              ?>
              <tr>
                <th scope="row"><?php echo $salon['id_salones']; ?></th>
                <td><?php echo utf8_encode($salon['nombre']); ?></td>
                <td><?php echo $salon['id_grados']; ?></td>
                <td><?php echo $salon['tiene_canon']; ?></td>
                <td><?php echo $salon['status']; ?></td>
                <td>
          ...
          <div class="form">
            <form class="form-register" id="user-form">
              ...
              <input type="text" name="id_grados" id="id_grados" placeholder="Grados" />
              <input type="text" name="tiene_canones" id="tiene_canones" placeholder="Tiene Cañones" />
              <input type="text" name="status" id="status" placeholder="Status" />
              <button type="button" id="btn-form">Registrar Salon <i class="fas fa-eye fa-sm"></i></button>
            </form>
          </div>
          <!-- FIN FORMULARIO -->
        </div>
